function reajustar(){
    ...
    res.innerHTML=`<p><strong>${nome} recebeu um amento salarial ! </strong></p> <p> O salário actual era ${salario} kz </p> <p>Com um aumento de ${porcentagem}%, o salário vai aumentar ${aumento} kz no proximo mês.</p> <p>E a partir daí, ${nome} vai passar a ganhar ${reajuste}.</p>`
}
